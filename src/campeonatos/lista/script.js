    ...
    list2.forEach(data => {
        row = `
            <tr>
                ...
                <td class="infos_camp"> <input type="button" onclick="location.href='/campeonatos/update?id=${data.id_campeonato}'" value="Editar" class="btnEditar"></td>
                <td class="infos_camp"> <input type="button" onclick="confirmar(${data.id_campeonato})" value="Excluir" class="btnExcluir"></td>   
            </tr> 
        `
